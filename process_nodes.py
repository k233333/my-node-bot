...
TOTAL_LIMIT = 300 
BACKUP_VMESS_POOL = "https://raw.githubusercontent.com/aiboboxx/v2rayfree/main/v2" # 灾备 VMESS 数据源
...
def main():
    ...
    if backup_vmess_links:
        ...
        <h3 style="color: #e74c3c;">🆘 紧急灾备节点 (防失联)</h3>
        <p style='font-size: 12px; color: #666;'>随机抽取 20 个 VMESS 节点。当 Pages 直链解析失效或被阻断时，请手动全选以下内容复制，并于小火箭中选择“从剪贴板添加”。</p>
        <textarea style='width: 100%; height: 120px; font-size: 10px; background-color: #f8f9fa; border: 1px solid #ced4da; padding: 8px; border-radius: 4px; resize: none;' readonly>{backup_text}</textarea>
        """
